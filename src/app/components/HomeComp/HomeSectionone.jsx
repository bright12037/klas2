    ...
    <div>
      <div className='min-h-screen bg-gradient-to-b from-blue-700 to-violet-500 flex flex-col'>
         ...
         <nav className='flex items-center bg-white py-4 mx-12 my-10 align-center text-center rounded-xl shadow-md'>
          ...
          <Link href="https://klas2.vercel.app/"><h2 className='flex items-center'><Image src={logo} width={60} alt='k'/> Klas</h2></Link>
          </div>
        ...
        <main className='flex-grow'>
            <div className='w-auto lg:flex'>
              <div className='pl-10 mt-28'>
                ...
                <p className='pt-10 text-xl font-medium text-gray-300'>Create and sell your ebooks, courses, and live classes- <br /> all on klas</p>
      ...
      <div className='min-h-screen bg-white '>
         ...
         <div className='flex gap-20'>
           <div className='pt-44 ml-14'>
            ...
            <p className='flex gap-2 text-xl text-neutral-900 pb-4'><span className='pt-1 text-blue-900'><LiaStarOfLifeSolid /></span>One-click recordings and cloud storage</p>
